...
/*
    ...
    /**
     * Get Token:
     * curl -X POST -vu html5:password http://localhost:9191/uaa/oauth/token -H "Accept: application/json" -d "password=123456&username=wallace&grant_type=password&scope=openid&client_secret=password&client_id=html5"
     *
     * Get names:
     * curl http://localhost:9999/reservations/names -H "Authorization: Bearer 87c20d80-bab0-4471-8861-79ff0d592b62"
     *
     * @return
     */
    @GetMapping("/names")
